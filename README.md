...
[Vanilla Modpack](https://github.com/MentoskaPraha/vanilla-modpack) - the modpack this modpack is based on.
...
### Create Mods
These are all the mods related to Create.
...
### Extra Sound Mods
These mods work with sound adding some neat features.

|  Mod Name and Link | Client/Server Info | Use Status | Ready for 1.21 Upgrade |
| :---------------------| :-----------------: | :-------------------: | :---------------: |
| [Simple Voice Chat](https://modrinth.com/mod/9eGKb6K1) | Client and Server | Used |  |
| [AudioPlayer](https://modrinth.com/mod/SRlzjEBS) | Client and Server | Used |  |

### Extra Misc Mods
These mods add some extra bits and bobs.
